  ...
  return (
    <div className="mt-4">
      ...
      <div className="mt-4">
        ...
        <img width="100%" className="rounded" src={brainImage1} alt="brain1" />
      </div>

      {/* subject 2 */}
      <div className="mt-4">
        <div className="fs-5">Subject 2</div>
        <img width="100%" className="rounded" src={brainImage2} alt="brain2" />
      </div>

      {/* subject 3 */}
      <div className="mt-4">
        <div className="fs-5">Subject 3</div>
        <img width="100%" className="rounded" src={brainImage3} alt="brain3" />
      </div>

      {/* subject 4 */}
      <div className="mt-4">
        <div className="fs-5">Subject 4</div>
        <img width="100%" className="rounded" src={brainImage4} alt="brain4" />
      </div>

      {/* subject 5 */}
      <div className="mt-4">
        <div className="fs-5">Subject 5</div>
        <img width="100%" className="rounded" src={brainImage5} alt="brain5" />
      </div>
    </div>
  );
};
