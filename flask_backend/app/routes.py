...
def list_files():
    data_folder = os.path.join(os.path.dirname(__file__), '/Users/iqranaz/Downloads/course-project-bic-cpascx-graphs-spikes-thresholds/flask_backend/app/data')
...
def generate_plots():
    ...
    data_path = '/Users/iqranaz/Downloads/course-project-bic-cpascx-graphs-spikes-thresholds/flask_backend/app/data/sub-01_task-tv_run-02_desc-confounds_timeseries.tsv'
    graphs = Visualizations(data_path)

    # Create plots and save to files
    plt.figure(figsize=(10, 5))
    graphs.plot_rotations()
    rotations_plot_path = '/Users/iqranaz/Downloads/course-project-bic-cpascx-graphs-spikes-thresholds/flask_backend/app/static/images2/rotations_plot.png'
    plt.savefig(rotations_plot_path)
    plt.close()

    plt.figure(figsize=(10, 5))
    graphs.plot_translations()
    translations_plot_path = '/Users/iqranaz/Downloads/course-project-bic-cpascx-graphs-spikes-thresholds/flask_backend/app/static/images2/translations_plot.png'
    plt.savefig(translations_plot_path)
    plt.close()

    plt.figure(figsize=(10, 5))
    graphs.plot_framewise()
    framewise_plot_path = '/Users/iqranaz/Downloads/course-project-bic-cpascx-graphs-spikes-thresholds/flask_backend/app/static/images2/framewise_plot.png'
    ...
    for plot_name, plot_path in [('rotations', rotations_plot_path), ('translations', translations_plot_path), ('framewise', framewise_plot_path)]:
        with open(plot_path, 'rb') as plot_file:
            ...
            plots[plot_name] = f'data:images2/png;base64,{plot_base64}'
...
def plotter():
    ...
    for plot_name, plot_function in [('rotations', graphs.plot_rotations), ('translations', graphs.plot_translations), ('framewise', graphs.plot_framewise)]:
        plt.figure(figsize=(10, 5))
        plot_function()
        plot_path = f'/Users/iqranaz/Downloads/course-project-bic-cpascx-graphs-spikes-thresholds/flask_backend/app/images2/{plot_name}_plot.png'  # Save in the static folder
